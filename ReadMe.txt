...
-second chance alg.). 
-LRU-REF8 (Least-recently-used Reference-bit
- Optimal Page Replacement Algorithm
Implementation, using 8 reference bits)

 The default will be FIFO.

OUTPUT:

Final output should compare Optimal page replacement algorithm, and the performance of the replacement-policy chosen by the user in terms of number of page replacements for the given string.
...
Implementation, using 8 reference bits)
The default will be FIFO.
?i input file : Read the page reference sequence from a specified file. 
If not given,the sequence should be read from STDIN (ended with ENTER). 